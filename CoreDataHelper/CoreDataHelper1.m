...
static CoreDataHelper1 *_instance;

@implementation CoreDataHelper1
...
+ (NSManagedObjectContext *) getManagedObjectContext{
    return [CoreDataHelper1 sharedInstance].persistentContainer.viewContext;
}
+ (void)setMangedObjectName:(NSString *)name{
    [[CoreDataHelper1 sharedInstance] setObjectModelName:name];
}
